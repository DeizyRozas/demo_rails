...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference("Libro.count") do
      post libros_url, params: { libro: { descripcion: @libro.descripcion, nombre: @libro.nombre, paginas: @libro.paginas } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { descripcion: @libro.descripcion, nombre: @libro.nombre, paginas: @libro.paginas } }
