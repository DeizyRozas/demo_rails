class LibrosController < ApplicationController
  ...
  def index
    @libros = Libro.all #variable de instancia que se puede usar dentro del metodo, libro es el objeto
    ##.all select * from libros#active recolr ORM de rails hace el paralelismo entre el archivo y la tabla
  end
  ...
  private
    ...
    def libro_params
      params.require(:libro).permit(:nombre, :descripcion, :paginas, :precio)
    end
end
